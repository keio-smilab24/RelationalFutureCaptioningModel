...
class Args:
    root: str = config(long='--root', short='-r', default='/home/taku/RFCM/RelationalFutureCaptioningModel/data/Ponnet/S-set4/')
    json_path: str = config(long='--json_path', short='-jp', default="/home/taku/RFCM/RelationalFutureCaptioningModel/data/Ponnet/S-set4/att_path.jsonl")
    csv_path: str = config(long='--csv_path', short='-cp', default="/home/taku/RFCM/RelationalFutureCaptioningModel/data/Ponnet/S-set4/att_path.csv")
    imageNum: int = 2000
